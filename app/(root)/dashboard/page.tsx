...
const DashboardPage = () => {
  ...
  return (
    <div className="bg-gray-100 min-h-screen flex flex-col md:flex-row">
      ...
      <div className={`flex-1 ${user?.email === 'admin.evote@gmail.com' ? (isCollapsed ? 'md:ml-20' : 'md:ml-64') + ' transition-margin duration-300' : ''}`}>
        <Navbar user={user!} />
        ...
        <main className="container font-ibm-plex-serif mx-auto mt-8 px-4">
          <div className='mb-8'>
            ...
            <p className='text-sm truncate font-normal text-gray-700'>
              {user?.email}
            </p>
          </div>
