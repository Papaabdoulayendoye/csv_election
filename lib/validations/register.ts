...
export const RegisterValidation = z.object({
  nom: z.string().nonempty('Nom d\'utilisateur requis').min(4, 'Minimum 4 caractères'),
  email: z.string().email('Adresse e-mail invalide'),
  formation: z.string().nonempty("Seectionner votre formation"),
  classe: z.string().nonempty("Seectionner une classe"),
